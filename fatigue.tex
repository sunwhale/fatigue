...
Fatigue tests were performed in air and under mechanical strain control with three different strain paths. The multi-axial fatigue tests ran under given axial strain $\varepsilon$ and shear strain $\gamma$ in a cycle. The proportional and the non-proportional loading paths are shown in Figures \ref{Fig:LoadPath}. While Fig. \ref{Fig:LoadPath} (b) shows a proportional load,  Figs. \ref{Fig:LoadPath} (c) and (d) define two non-proportional loads, with very different characteristics.
