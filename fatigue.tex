...
\begin{figure*}
  ...
  \nonumber
    \centering
    \begin{overpic}[width=8.0cm]{7033-16.jpg}
      \put(0,65){\fcolorbox{white}{white}{(c)}}
      \put(50,50){\color{white}\thicklines\vector(-1,1){20}}
    \end{overpic}
  \end{minipage}%
...
Fatigue lives are strongly influenced by the strain path. At the same equivalent mechanical strain and the same in phase IP temperature conditions, the non-proportional diamond path test has a shorter lifetime than the uniaxial and 45$^\circ$ proportional path test.
