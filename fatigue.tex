...
\begin{figure*}
  ...
  \caption{Observation of fatigue striations on fractures surface: (a)TC-IF 0.45\%, (b)TC-IP 0.6\%, (c)TC-OP 0.65\%, (d)PRO-IP 0.6\%, (e)NPR-IP 0.7\%, (f)NPR-IP 0.5\%.  Arrows show the crack propagation direction.}
...
\begin{figure*}
  ...
  \nonumber
    ...
    \begin{overpic}[width=7.5cm]{NF-NP-TMF-BM.pdf}
      \put(70,20){\fcolorbox{white}{white}{(a) BM}}
    \end{overpic}
  \end{minipage}%
  \begin{minipage}[t]{0.5\linewidth}
    \centering
  ...
  \begin{minipage}[t]{0.5\linewidth}
    ...
    \begin{overpic}[width=7.5cm]{NF-NP-TMF-Chu.pdf}
      \put(70,20){\fcolorbox{white}{white}{(d) Chu}}
    \end{overpic}
  \end{minipage}
  ...
  \begin{minipage}[t]{0.5\linewidth}
    ...
    \begin{overpic}[width=7.5cm]{NF-NP-TMF-Study.pdf}
      \put(70,20){\fcolorbox{white}{white}{(f) Study}}
    \end{overpic}
  \end{minipage}

  \caption{Life prediction of multi-axial thermo-mechanical fatigue: (a)Brown-Miller Model, (b)Fatemi-Socie Model, (c) Smith-Watson-Topper Model, (d)Chu-Conle-Bonnen Model, (e)Liu Tension Energy Model, (f)Study Model.}
...
\subsection{Our Strain Energy Models}
...
\begin{equation}
A = {\left[ {1 + C\int_{{t_0}}^{{t_0} + {t_{cyc}}} {\eta \left( t \right)\exp \left( {\frac{{ - Q\left( t \right)}}{{RT\left( t \right)}}} \right)dt} } \right]^k}
\end{equation}
